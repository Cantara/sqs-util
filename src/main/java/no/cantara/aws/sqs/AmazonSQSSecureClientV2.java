...
public class AmazonSQSSecureClientV2 extends AmazonSQSClientBase {
    ...
    private AmazonSQSSecureClientV2(final AmazonSQS delegate,
                            final Regions awsRegion,
    ...
    public static AmazonSQSSecureClientV2 create(final AWSCredentialsProvider awsCredentialsProvider,
                                                 final Regions awsRegion,
                                                 final String kmsCmkId,
                                                 final String s3Bucket) {
        ...
        return new AmazonSQSSecureClientV2(amazonSQS, awsRegion, kmsCmkId, s3Bucket, amazonS3, amazonSNS);
    }

    public static AmazonSQSSecureClientV2 create(final Regions awsRegion,
                                                 final String kmsCmkId,
                                                 final String s3Bucket) {
     ...
     */
    public AmazonSQSSecureClientV2 withSnsNotificationsEnabled(String queueName, boolean snsNotificationsEnabled) {
