...
public class SecureSqsV2IntegrationTest {
    ...
    private static AmazonSQSSecureClientV2 sqsClient;
    private static final Logger log = LoggerFactory.getLogger(SecureSqsV2IntegrationTest.class);

    @BeforeClass
    public static void createClientAndQueue() {
        sqsClient = AmazonSQSSecureClientV2.create(REGION, DEFAULT_CMK, S3_BUCKET);
